...
#define MAX_HISTORY_BUFF		(2048)

struct history_buff {
	u32 index;
	u32 save_addr[MAX_HISTORY_BUFF];
	u32 orig_addr[MAX_HISTORY_BUFF];
...
static inline bool set_sysmmu_active(struct sysmmu_drvdata *data, int pcie_vid)
{
...
static inline bool set_sysmmu_inactive(struct sysmmu_drvdata *data, int pcie_vid)
{
